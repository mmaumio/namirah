...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'namirah' ),
				'change'       => esc_attr__( 'Change image', 'namirah' ),
				'default'      => esc_attr__( 'Default', 'namirah' ),
				'remove'       => esc_attr__( 'Remove', 'namirah' ),
				'placeholder'  => esc_attr__( 'No image selected', 'namirah' ),
				'frame_title'  => esc_attr__( 'Select image', 'namirah' ),
				'frame_button' => esc_attr__( 'Choose image', 'namirah' ),
			)
		);
	}
