...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_attr_e( 'Select image', 'namirah' ); ?>',
	change: '<?php esc_attr_e( 'Change image', 'namirah' ); ?>',
	'default': '<?php esc_attr_e( 'Default', 'namirah' ); ?>',
	remove: '<?php esc_attr_e( 'Remove', 'namirah' ); ?>',
	placeholder: '<?php esc_attr_e( 'No image selected', 'namirah' ); ?>',
	frame_title: '<?php esc_attr_e( 'Select image', 'namirah' ); ?>',
	frame_button: '<?php esc_attr_e( 'Choose image', 'namirah' ); ?>',
} );
#>
