	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_attr__( 'No File Selected', 'namirah' ),
				'remove'               => esc_attr__( 'Remove', 'namirah' ),
				'default'              => esc_attr__( 'Default', 'namirah' ),
				'selectFile'           => esc_attr__( 'Select File', 'namirah' ),
				'standardFonts'        => esc_attr__( 'Standard Fonts', 'namirah' ),
				'googleFonts'          => esc_attr__( 'Google Fonts', 'namirah' ),
				'defaultCSSValues'     => esc_attr__( 'CSS Defaults', 'namirah' ),
				'defaultBrowserFamily' => esc_attr__( 'Default Browser Font-Family', 'namirah' ),
			)
		);
