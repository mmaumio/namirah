...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'namirah' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'namirah' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'namirah' ),
			'200'       => esc_attr__( 'Light 200', 'namirah' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'namirah' ),
			'300'       => esc_attr__( 'Book 300', 'namirah' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'namirah' ),
			'400'       => esc_attr__( 'Normal 400', 'namirah' ),
			'regular'   => esc_attr__( 'Normal 400', 'namirah' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'namirah' ),
			'500'       => esc_attr__( 'Medium 500', 'namirah' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'namirah' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'namirah' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'namirah' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'namirah' ),
			'700'       => esc_attr__( 'Bold 700', 'namirah' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'namirah' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'namirah' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'namirah' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'namirah' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'namirah' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'namirah' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'namirah' ),
		);
	}
