	...
	public static function register_scripts() {
		...
		if ( ! is_admin() ) {
			...
			wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
				'clear'         => __( 'Clear', 'namirah' ),
				'defaultString' => __( 'Default', 'namirah' ),
				'pick'          => __( 'Select Color', 'namirah' ),
				'current'       => __( 'Current Color', 'namirah' ),
			) );
		}
		...
		wp_localize_script( 'cmb2-scripts', 'cmb2_l10', apply_filters( 'cmb2_localized_data', array(
			...
			'defaults'         => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => __( 'mm/dd/yy', 'namirah' ),
					'dayNames'        => explode( ',', __( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'namirah' ) ),
					'dayNamesMin'     => explode( ',', __( 'Su, Mo, Tu, We, Th, Fr, Sa', 'namirah' ) ),
					'dayNamesShort'   => explode( ',', __( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'namirah' ) ),
					'monthNames'      => explode( ',', __( 'January, February, March, April, May, June, July, August, September, October, November, December', 'namirah' ) ),
					'monthNamesShort' => explode( ',', __( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'namirah' ) ),
					'nextText'        => __( 'Next', 'namirah' ),
					'prevText'        => __( 'Prev', 'namirah' ),
					'currentText'     => __( 'Today', 'namirah' ),
					'closeText'       => __( 'Done', 'namirah' ),
					'clearText'       => __( 'Clear', 'namirah' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => __( 'Choose Time', 'namirah' ),
					'timeText'      => __( 'Time', 'namirah' ),
					'hourText'      => __( 'Hour', 'namirah' ),
					'minuteText'    => __( 'Minute', 'namirah' ),
					'secondText'    => __( 'Second', 'namirah' ),
					'currentText'   => __( 'Now', 'namirah' ),
					'closeText'     => __( 'Done', 'namirah' ),
					'timeFormat'    => __( 'hh:mm TT', 'namirah' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => __( 'Use this file', 'namirah' ),
				'remove_image' => __( 'Remove Image', 'namirah' ),
				'remove_file'  => __( 'Remove', 'namirah' ),
				'file'         => __( 'File:', 'namirah' ),
				'download'     => __( 'Download', 'namirah' ),
				'check_toggle' => __( 'Select / Deselect All', 'namirah' ),
			),
		) ) );
